...
<html>
  ...
  <div align="center" >
  	<h1>注册</h1><hr>
  	<form action="${pageContext.request.contextPath}/sys/regist.do" method="POST" onsubmit="return checkForm()">
  		<table>
  			<tr>
  				<td>用户名:</td>
  			...
  			<tr>
  				...
  				<td><img src="${pageContext.request.contextPath }/sys/valiImg.do" onclick="changeImg(this)" style="cursor: pointer;"/></td>
  			</tr>		
  		</table>
  	</form>
  	</div>
